...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span style="font-size: 10px; position: relative; top: -23px; left: 33px;">
    ...
    <table ID="tablaCamposProducto" BorderStyle="Inset" BorderWidth="5px" style="width:60%; border: solid; border-color: black; background-color: rgb(255 255 255);">
